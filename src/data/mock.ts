...
const SVG_TM_NAMEPLATE = `data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="600" height="400" viewBox="0 0 600 400"><rect width="600" height="400" fill="%23050505"/><rect x="40" y="40" width="520" height="320" rx="12" fill="%230e0e0e" stroke="%23222222" stroke-width="2"/><rect x="70" y="80" width="460" height="120" rx="8" fill="%23000000" stroke="%23ffffff" stroke-width="1.5" stroke-dasharray="4"/><text x="90" y="115" fill="%23888888" font-family="monospace" font-size="13" font-weight="bold">OCR DETECTED [98% CONFIDENCE]</text><text x="90" y="155" fill="%23FFFFFF" font-family="monospace" font-size="28" font-weight="900">MB5085-2274-K</text><text x="90" y="180" fill="%23aaaaaa" font-family="monospace" font-size="13">MFG: 2023-03 · JIS-E-4001 COMPLIANT</text><text x="70" y="240" fill="%23ffffff" font-family="sans-serif" font-size="18" font-weight="bold">MITSUBISHI ELECTRIC ROLLING STOCK DIVISION</text><text x="70" y="270" fill="%23888888" font-family="monospace" font-size="13">TRACTION MOTOR TM-450 · 220 kW · 18,420 RUNNING HOURS</text><circle cx="500" cy="300" r="26" fill="%2310b981" fill-opacity="0.1" stroke="%2310b981" stroke-width="2"/><path d="M492 300 l6 6 l14 -14" fill="none" stroke="%2310b981" stroke-width="3" stroke-linecap="round"/></svg>`
...
const SVG_TM_CONTEXT = `data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="600" height="400" viewBox="0 0 600 400"><rect width="600" height="400" fill="%23050505"/><circle cx="160" cy="220" r="100" fill="%230e0e0e" stroke="%23262626" stroke-width="6"/><circle cx="160" cy="220" r="40" fill="%23000000" stroke="%23ffffff" stroke-width="2"/><circle cx="440" cy="220" r="100" fill="%230e0e0e" stroke="%23262626" stroke-width="6"/><circle cx="440" cy="220" r="40" fill="%23000000" stroke="%23ffffff" stroke-width="2"/><rect x="80" y="120" width="440" height="24" rx="4" fill="%231a1a1a" stroke="%23333333" stroke-width="2"/><rect x="220" y="160" width="160" height="90" rx="8" fill="%23000000" stroke="%23FFFFFF" stroke-width="1.5" stroke-dasharray="6"/><text x="235" y="200" fill="%23FFFFFF" font-family="monospace" font-size="13" font-weight="bold">TRACTION MOTOR BAY</text><text x="235" y="225" fill="%23888888" font-family="monospace" font-size="12">MUTTOM DEPOT BAY #4</text><text x="50" y="360" fill="%23888888" font-family="monospace" font-size="13">DEPOT INSPECTION ANGLE 1 // KOCHI METRO</text></svg>`
...
const SVG_APU_NAMEPLATE = `data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="600" height="400" viewBox="0 0 600 400"><rect width="600" height="400" fill="%23050505"/><rect x="40" y="40" width="520" height="320" rx="12" fill="%230e0e0e" stroke="%23222222" stroke-width="2"/><rect x="70" y="80" width="460" height="120" rx="8" fill="%23000000" stroke="%23ffffff" stroke-width="1.5" stroke-dasharray="4"/><text x="90" y="115" fill="%23888888" font-family="monospace" font-size="13" font-weight="bold">OCR DETECTED [99% CONFIDENCE]</text><text x="90" y="155" fill="%23FFFFFF" font-family="monospace" font-size="28" font-weight="900">TOSH-APU-8820-X</text><text x="90" y="180" fill="%23aaaaaa" font-family="monospace" font-size="13">MFG: 2022-11 · JIS-E-5006 COMPLIANT</text><text x="70" y="240" fill="%23ffffff" font-family="sans-serif" font-size="18" font-weight="bold">TOSHIBA INFRASTRUCTURE SYSTEMS</text><text x="70" y="270" fill="%23888888" font-family="monospace" font-size="13">STATIC INVERTER APU-120 · 415V 3-PHASE · 120 kVA</text><circle cx="500" cy="300" r="26" fill="%2310b981" fill-opacity="0.1" stroke="%2310b981" stroke-width="2"/><path d="M492 300 l6 6 l14 -14" fill="none" stroke="%2310b981" stroke-width="3" stroke-linecap="round"/></svg>`
...
export const FAILURE_SCENARIOS: FailureScenario[] = [
  {
    ...
    faultCode: 'E-TM-204',
    jisCode: 'JIS E-4001',
    symptom: 'Armature winding flashover / end-winding burst at commutator end',
    failureDescription:
      'Catastrophic armature failure observed at commutator end: copper conductors ripped apart and fanned outward, insulation burnt and carbonized, winding lashing/banding destroyed. Armature no longer serviceable.',
    rootCause:
      'Armature winding insulation failure resulting in turn-to-turn short circuit and commutator flashover. The resulting fault current produced electromagnetic forces that mechanically displaced and damaged the end windings. Secondary damage: end-winding deformation, insulation destruction, possible commutator and brush gear damage — complete armature rewind required.',
    ...
    costs: {
      partReplacementInr: 3600000,
      partReplacementJpy: 6390000,
      laborInr: 780000,
      laborJpy: 1385000,
      testingInr: 440000,
      testingJpy: 785000,
