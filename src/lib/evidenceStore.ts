...
export const DEFAULT_NAMEPLATE_SVG = `data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="600" height="400" viewBox="0 0 600 400"><rect width="600" height="400" fill="%230b1526"/><rect x="40" y="40" width="520" height="320" rx="12" fill="%23132238" stroke="%23223e66" stroke-width="3"/><rect x="70" y="80" width="460" height="120" rx="8" fill="%2309111e" stroke="%23f59e0b" stroke-width="2" stroke-dasharray="4"/><text x="90" y="115" fill="%235a7596" font-family="monospace" font-size="14" font-weight="bold">OCR DETECTED [91% CONFIDENCE]</text><text x="90" y="155" fill="%23f59e0b" font-family="monospace" font-size="28" font-weight="900">MB5085-2274-K</text><text x="90" y="180" fill="%23738ea8" font-family="monospace" font-size="14">MFG: 2023-03 · JIS-E-4001 COMPLIANT</text><text x="70" y="240" fill="%23ffffff" font-family="sans-serif" font-size="18" font-weight="bold">MITSUBISHI ELECTRIC ROLLING STOCK DIVISION</text><text x="70" y="270" fill="%23738ea8" font-family="monospace" font-size="13">3-PHASE INDUCTION MOTOR · 220 kW · 18,420 RUNNING HOURS</text><circle cx="500" cy="300" r="28" fill="%23062618" stroke="%2310b981" stroke-width="2"/><path d="M490 300 l8 8 l16 -16" fill="none" stroke="%2310b981" stroke-width="3" stroke-linecap="round"/></svg>`
...
export const DEFAULT_BOGIE_SVG = `data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="600" height="400" viewBox="0 0 600 400"><rect width="600" height="400" fill="%230a1322"/><circle cx="160" cy="220" r="100" fill="%23132238" stroke="%232e4d77" stroke-width="6"/><circle cx="160" cy="220" r="40" fill="%23060c18" stroke="%23f59e0b" stroke-width="3"/><circle cx="440" cy="220" r="100" fill="%23132238" stroke="%232e4d77" stroke-width="6"/><circle cx="440" cy="220" r="40" fill="%23060c18" stroke="%23f59e0b" stroke-width="3"/><rect x="80" y="120" width="440" height="30" rx="4" fill="%231f375b" stroke="%233b6399" stroke-width="2"/><rect x="220" y="160" width="160" height="90" rx="8" fill="%230c182a" stroke="%23f59e0b" stroke-width="2" stroke-dasharray="6"/><text x="235" y="200" fill="%23f59e0b" font-family="monospace" font-size="13" font-weight="bold">TRACTION MOTOR BAY</text><text x="235" y="225" fill="%23738ea8" font-family="monospace" font-size="12">AXLE MOUNTING: OK</text><text x="50" y="360" fill="%235a7596" font-family="monospace" font-size="13">DEPOT INSPECTION ANGLE 3 // MUTTOM BAY #4</text></svg>`
